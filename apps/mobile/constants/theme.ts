...
export const darkColors: ColorPalette = {
  background: "#070C1F",
  surface: BRAND.navy,
  surfaceElevated: "#121C48",
  surfaceSecondary: "#101A40",
  foreground: "#FFFFFF",
  text: "#E4E9F5",
  textSecondary: "#C5CDE0",
  muted: "#9AA6C4",
  mutedForeground: "#6E7A9A",
  border: "#243056",
  borderLight: "#1A2548",
  cta: "#FFFFFF",
  ctaForeground: BRAND.navy,
  ctaPressed: "#E8ECF4",
  ctaMuted: "rgba(255, 255, 255, 0.1)",
  selected: "#FFFFFF",
  selectedForeground: BRAND.navy,
  selectedMuted: "rgba(255, 255, 255, 0.12)",
  chipBackground: "#121C48",
  primary: BRAND.primary,
  primaryForeground: "#FFFFFF",
  primaryText: "#FFFFFF",
  primaryMuted: "rgba(98, 84, 243, 0.22)",
  primarySubtle: "rgba(98, 84, 243, 0.3)",
  navy: BRAND.navy,
  accent: BRAND.accent,
  destructive: "#F87171",
  destructiveForeground: "#FFFFFF",
  ...
  discount: "#FCA5A5",
  discountMuted: "rgba(252, 165, 165, 0.16)",
  success: "#34D399",
