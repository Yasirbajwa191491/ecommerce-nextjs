      ...
      <form onSubmit={handleSubmit} role="search" className="w-full">
        <div className="flex h-10 items-stretch overflow-hidden rounded-full border border-border/80 bg-background shadow-sm transition-shadow focus-within:border-[#6254f3]/40 focus-within:shadow-md sm:h-11">
          <Input
            ...
            style={inputStyle}
          />
          <div className="flex shrink-0 items-center border-l border-border/80 pl-0.5">
            <Button
              variant="ghost"
              size="icon"
              render={
              ...
              className="size-10 shrink-0 rounded-none text-muted-foreground hover:bg-muted hover:text-brand-primary sm:size-11"
            >
              <Camera className="size-[1.125rem]" strokeWidth={1.75} />
            </Button>
            <Button
              type="submit"
              variant="ghost"
